...
6. **Native performance:** On the recorded GitHub runner and 200,000 iterations per schema and language, median rank speedup relative to Python was 51.6x for C and 63.4x for Rust. Median unrank speedup was 135.2x for C and 38.6x for Rust.
